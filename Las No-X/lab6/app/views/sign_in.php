...
<main class="container">
    ...
    <section>
        ...
        <form class="form form__sign_in" name="form__sign_in" method="post">
            <div class="container-fluid">
                ...
                <?endif?>
                <div class="row">
                    <div class="col-xs-12 col-md-5 col-md-offset-1 form-group <?= $form->state('login') ?>">
                        <input placeholder="Логин:" type="text" name="login" id="form__login" class="form-control" required
                               <?= $form->value('login') ?>>
                        <?= $form->hint('login') ?>
                    </div>
                    <br>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-10 col-md-offset-1">
                        <input type="submit" value="Войти" class="form-control btn btn-block btn-primary">
                        <br>
                        <br>
                    </div>
                </div>
